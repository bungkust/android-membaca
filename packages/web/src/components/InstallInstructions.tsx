  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/10 via-accent/10 to-secondary/10 p-4 py-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-card rounded-3xl shadow-playful p-8 text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8">
            Ikuti langkah-langkah berikut untuk menginstall Belajar Membaca sebagai PWA
          </p>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 mb-6 border-2 border-blue-200">
            <div className="flex items-center justify-center mb-4">
              ...
              <h2 className="text-2xl font-bold text-blue-700">💻 Desktop</h2>
            </div>
            ...
            <div className="text-left space-y-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Menu → Install "Belajar Membaca"</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 mb-6 border-2 border-green-200">
            <div className="flex items-center justify-center mb-4">
              ...
              <h2 className="text-2xl font-bold text-green-700">📱 Android</h2>
            </div>
          ...
          <div className="bg-gradient-to-br from-pink-50 to-rose-50 rounded-2xl p-6 mb-8 border-2 border-pink-200">
            <div className="flex items-center justify-center mb-4">
              <Apple className="w-8 h-8 text-pink-600 mr-3" />
              <h2 className="text-2xl font-bold text-pink-700">🍎 iOS (Safari)</h2>
            </div>
          ...
          <div className="bg-gradient-to-r from-purple-50 to-violet-50 rounded-2xl p-6 border-2 border-purple-200">
            <h3 className="text-xl font-bold text-purple-700 mb-3">🎉 Setelah Install:</h3>
